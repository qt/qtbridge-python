...
Node {
    ...
    component AccessoryMaterial: PrincipledMaterial {
        readonly property var accessoryModel: root.accessoryModel
        ...
        baseColor: {
            ...
            if (!accessoryModel)
                return defaultColor
            const color = accessoryModel.color_of(accessoryName)
            return (color !== undefined && color !== "") ? color : defaultColor
        }
    }
