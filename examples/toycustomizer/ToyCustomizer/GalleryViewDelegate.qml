...
Item {
    ...
    required property int original_price
    required property int discount_percent
    ...
    ColumnLayout {
        ...
        RowLayout {
            ...
            ToyLabel {
                ...
                text: Number(delegateItem.original_price * (1 - delegateItem.discount_percent / 100)).toLocaleCurrencyString()
            }
            ColorIcon {
        ...
        RowLayout {
            visible: delegateItem.discount_percent
            Layout.fillWidth: true
            ToyLabel {
                id: originalPrice
                ...
                font.strikeout: true
                color: "#6A6A8D"
                text: delegateItem.original_price
            }
            ToyLabel {
                id: discountPercent
                textStyle: ApplicationConfig.TextStyle.Price_S
                color: "#6A6A8D"
                text: qsTr("( -%1% )").arg(delegateItem.discount_percent)
            }
        }
